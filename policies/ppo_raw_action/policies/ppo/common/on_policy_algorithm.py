...
from policies.ppo.common.base_class import BaseAlgorithm
from policies.ppo.common.buffers import DictRolloutBuffer, RolloutBuffer
from stable_baselines3.common.callbacks import BaseCallback
from policies.ppo.common.policies import ActorCriticPolicy,ACT_ActorCriticPolicy
from policies.ppo.common.type_aliases import GymEnv, MaybeCallback, Schedule
from policies.ppo.common.utils import obs_as_tensor, safe_mean
        ...
        while n_steps < n_rollout_steps:
            ...
            with th.no_grad():
                ...
                if self.act_policy_config["temporal_agg"]:
                    actions, sample_raw_actions, values, log_probs = self.policy(obs_tensor)
                    # print("--------------------")
                else:
                    actions, values, log_probs = self.policy(obs_tensor)
            actions = actions.cpu().numpy()
            sample_raw_actions = sample_raw_actions.cpu().numpy()
